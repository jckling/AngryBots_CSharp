...
public class ObjectCache
{
    ...
    public void Initialize()
    {
        ...
        {
            objects[i] = MonoBehaviour.Instantiate(prefab);
    ...
    public GameObject GetNextObjectInCache()
    {
        ...
        {
            Debug.LogWarning(
                "Spawn of " + prefab.name + " exceeds cache size of " + cacheSize + "! Reusing already active object.",
                obj);
            Spawner.Destroy(obj);
        }
...
public class Spawner : MonoBehaviour
{
    ...
    public static void Destroy(GameObject objectToDestroy)
    {
        ...
        {
            Object.Destroy(objectToDestroy); // 这里不能省略，不然会造成递归调用栈溢出 
        }
    }
}