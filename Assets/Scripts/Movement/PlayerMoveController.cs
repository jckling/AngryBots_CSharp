...
public class PlayerMoveController : MonoBehaviour
{
    ...
    // Prepare a cursor point variable. This is the mouse position on PC and controlled by the thumbstick on mobiles.
 ...
 joystickLeft.position.x * screenMovementRight + joystickLeft.position.y * screenMovementForward;
#else
 ...
 joystickRight.position.x * screenMovementRight + joystickRight.position.y * screenMovementForward;
        ...
        Vector3 cursorWorldPosition =
            ScreenPointToWorldPointOnPlane(cursorScreenPosition, playerMovementPlane, mainCamera);
    ...
    void HandleCursorAlignment(Vector3 cursorWorldPosition)
    {
        ...
        Cursor.visible = (Input.mousePosition.x < 0 || Input.mousePosition.x > Screen.width ||
        ...
        float cursorScaleMultiplier =
            Mathf.Lerp(0.7f, 1.0f, Mathf.InverseLerp(0.5f, 4.0f, motor.facingDirection.magnitude));
