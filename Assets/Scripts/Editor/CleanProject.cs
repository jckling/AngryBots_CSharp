...
public class CleanProject : ScriptableWizard
{
    ...
    private static readonly string[] SafeDirectories =
        { "Pro Standard Assets", "Standard Assets", "Scripts", "Editor", "Gizmos" };
    ...
    public void OnWizardUpdate()
    {
        ...
        helpString =
            "Clean button will delete all unused assets INCLUDING SVN HISTORY. Make a backup before proceeding.";
        isValid = true;
    }
    ...
    private void DeleteUnusedAssets()
    {
        ...
        {
            EditorUtility.DisplayProgressBar("Getting Paths", ExcludeObject(dependency),
                n++ / (float)dependencies.Length);
        }
