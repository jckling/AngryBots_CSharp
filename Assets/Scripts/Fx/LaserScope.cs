...
public class LaserScope : MonoBehaviour
{
    ...
    void Update()
    {
        GetComponent<Renderer>().material.mainTextureOffset = new Vector2(
            Time.deltaTime * aniDir * scrollSpeed + GetComponent<Renderer>().material.mainTextureOffset.x,
            GetComponent<Renderer>().material.mainTextureOffset.y);
        GetComponent<Renderer>().material
            .SetTextureOffset("_NoiseTex", new Vector2(-Time.time * aniDir * scrollSpeed, 0.0f));
        ...
        if (hitInfo.transform)
        {
            ...
            GetComponent<Renderer>().material.mainTextureScale = new Vector2(0.1f * (hitInfo.distance),
                GetComponent<Renderer>().material.mainTextureScale.y);
            GetComponent<Renderer>().material
                .SetTextureScale("_NoiseTex", new Vector2(0.1f * hitInfo.distance * noiseSize, noiseSize));
            ...
            if (pointer)
            {
                ...
                pointer.transform.eulerAngles = new Vector3(90.0f, pointer.transform.eulerAngles.y,
                    pointer.transform.eulerAngles.z);
            }
        }
        else
        {
            ...
            GetComponent<Renderer>().material.mainTextureScale = new Vector2(0.1f * (maxDist),
                GetComponent<Renderer>().material.mainTextureScale.y);
            GetComponent<Renderer>().material
                .SetTextureScale("_NoiseTex", new Vector2(0.1f * (maxDist) * noiseSize, noiseSize));
        }
    }
}