...
public class ShaderDatabase : MonoBehaviour
{
    ...
    GameObject CreateCameraCoverPlane()
    {
        ...
        cookShadersObject.transform.localPosition = new Vector3(cookShadersObject.transform.localPosition.x,
            cookShadersObject.transform.localPosition.y, cookShadersObject.transform.localPosition.z + 1.55f);

        cookShadersObject.transform.localRotation = Quaternion.identity;
        Quaternion quaternion = Quaternion.identity;
        quaternion.eulerAngles = new Vector3(cookShadersObject.transform.localEulerAngles.x,
            cookShadersObject.transform.localEulerAngles.y, cookShadersObject.transform.localEulerAngles.z + 180);
        cookShadersObject.transform.localRotation = quaternion;

        cookShadersObject.transform.localScale = new Vector3(cookShadersObject.transform.localScale.x * 1.6f,
            cookShadersObject.transform.localScale.y * 1.5f, cookShadersObject.transform.localScale.z * 1.5f);
