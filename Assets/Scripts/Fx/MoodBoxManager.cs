...
public class MoodBoxManager : MonoBehaviour
{
    ...
    [HideInInspector] public GameObject[] splashManagers;
    [HideInInspector] public GameObject[] rainManagers;
    ...
    void UpdateFromMoodBox()
    {
        ...
        if (current)
        {
            ...
            else
            {
                ...
                currentData.colorMixBlend =
                    Mathf.Lerp(currentData.colorMixBlend, current.data.colorMixBlend, Time.deltaTime);
