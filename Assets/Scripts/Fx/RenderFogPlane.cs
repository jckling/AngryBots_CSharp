...
public class RenderFogPlane : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 toRight = cameraForRay.transform.right * CAMERA_NEAR * Mathf.Tan(fovWHalf * Mathf.Deg2Rad) *
                          CAMERA_ASPECT_RATIO;
        ...
        this.transform.localPosition =
            new Vector3(transform.localPosition.x, transform.localPosition.y, CAMERA_NEAR + 0.0001f);
